...
I.        Introduction: The following is a vision the Prophet Obadiah saw, and the words Adonai YHWH says about Edom (the descendants of Esau) (Ob 1:1a NET).[\[1\]](#_ftn1)
...
[\[1\]](#_ftnref1) *NET Bible®New English Translation (NET)*, Online Notes Edition (HarperCollins Christian Publishing; Biblical Studies Press, L.L.C., n.d.), Obadiah, https://netbible.com/copyright/.

[\[2\]](#_ftnref2) *The NET Bible First Edition Notes* (Biblical Studies Press, 2006), Notes for 1:16-#79.

[\[3\]](#_ftnref3) Michael Heiser, *The Unseen Realm: Recovering the Supernatural Worldview of the Bible*, First edition (Bellingham, WA: Lexham Press, 2015), *See the work(s) of Dr Heiser for more details on these themes.*.
